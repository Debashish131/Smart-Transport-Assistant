...
@section('maincontent')
    ...
    <div class="col-12">
        <div class="card m-b-30">
            <h4 class="mt-0 header-title">Update Complain</h4>
            <br>

            <div class="approve">
                @if($complain->Is_approved==false)
                    <form method="post" action="/approveByOfficer/{{$complain->id}}">
            ...
            <div>
                <br>
                <br>
                <form action="/updateComplainOfficer/{{$complain->id}}" method="post" id="myForm"
