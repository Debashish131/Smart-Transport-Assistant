...
@section('maincontent')
    <style>
        ...
        .card .banner {
            ...
            background-image: url("/{{"assets"}}/images/licence.jpg");
            background-position: center;
    ...
    <div class="banner">
        ...
        {{--            <path--}}
        {{--                d="m48.203 69.309c1.7344 0 3.1484-1.4141 3.1484-3.1484 0-0.27734-0.22266-0.5-0.5-0.5-0.27734 0-0.5 0.22266-0.5 0.5 0 1.1836-0.96484 2.1484-2.1484 2.1484s-2.1484-0.96484-2.1484-2.1484c0-0.27734-0.22266-0.5-0.5-0.5-0.27734 0-0.5 0.22266-0.5 0.5 0 1.7344 1.4141 3.1484 3.1484 3.1484z"></path>--}}
        {{--            <path--}}
    ...
    @forelse($license as $val)
        @if($val->owner->Is_approved==1)
            <h2 class="name">{{$val->owner->Creator}}</h2>
            <div class="title">Full Name :{{$val->owner->Name}}</div>
            <div class="title">Vehicle Type :{{$val->VehicleType}}</div>
            <div class="title">NID :{{$val->owner->NID}}</div>
            <div class="title">Vehicle Number :{{$val->Vehicle_number}}</div>
            <div class="title">BRTA office :{{$val->BRTAoffice}}</div>
            <div class="title">License Will Expire : <span style="color: #bd2130">{{$val->Expire_date}}</span></div>
        @else
            <span style="color: #bd2130">This License is not Approved By BRTA</span>
        @endif
    @empty
        <div>No data found! Please apply for register</div>
