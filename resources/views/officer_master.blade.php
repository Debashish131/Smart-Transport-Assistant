        ...
        <div class="sidebar-inner slimscrollleft">
            ...
            <div id="sidebar-menu">
                <ul>
                    ...
                    <li>
                        <a href="{{url('/officer')}}" class="waves-effect">
                    ...
                    <li>
                        <a href="{{url('/usercomplain_details')}}" class="waves-effect"><i
                                class="dripicons-clipboard "></i><span> Complain Details </span>
                        </a>
                    </li>
                    <li>
                        <a href="{{url('/emergencyList')}}" class="waves-effect"><i
                                class="ion ion-ios-alert"></i><span> User Emergency list </span>
                        </a>
                    </li>
                        ...
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <h4 class="page-title m-0">Wellcome {{Auth::user()->name}}</h4>
                                    </div>
                                {{--                                    <div class="col-md-4">--}}
